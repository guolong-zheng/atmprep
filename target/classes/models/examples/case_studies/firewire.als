 ...
 *
 * The specification is given below. Each signature introduces a basic holeType
 * and some relations whose first column has that holeType:
 *
 * \begin{itemize}
 *
 * \item {\em Msg} represents the holeType of messages. {\em Req} is the request
