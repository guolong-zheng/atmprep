...
-- all c: Component | ((c.^parts) & Component).cposition not in (c.cposition).*next --incorrect 3
 all c: Component | ((c.^parts) & Component).cposition not in (c.cposition).^next-- all c: Component | ((c.^parts) & Component).cposition not in (c.cposition).^next or no c.^parts --incorrect 5
