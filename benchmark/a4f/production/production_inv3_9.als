...
-- all c:Component,p:Product |some r:Robot,pos1,pos2:Position| c->p in parts and p->pos1 in cposition and r->pos2 in rposition implies pos1=pos2 --incorrect 8 
 all c:Component,p:Product, r:Robot,pos1,pos2:Position| c->p in parts and p->pos1 in cposition and r->pos2 in rposition implies pos1=pos2-- all c:Component.cposition, r:Robot | some r.rposition & c --incorrect 10
