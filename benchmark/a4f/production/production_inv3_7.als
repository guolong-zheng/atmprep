...
-- all c:Component, r:Robot | c.cposition = r.rposition --incorrect 6 
 all c:Component, r:Robot | c.cposition in r.rposition-- all c:Component,p:Product |some r:Robot,pos1,pos2:Position| c->p in parts and p->pos1 in cposition and r->pos2 in rposition implies pos1=pos2 --incorrect 8 
