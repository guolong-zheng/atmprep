...
-- all c: Component | ((c.^parts) & Component).cposition not in (c.cposition).^next --incorrect 4 
 all c: Component | ((c.^parts) & Component).cposition not in (c.cposition).^next or no c.^parts-- all c: Component | ((c.parts) & Component).cposition not in (c.cposition).^next --incorrect 6
