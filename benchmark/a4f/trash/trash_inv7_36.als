...
-- all x,y : File | x->y in link implies x not in Trash  --incorrect 35
 all x,y :File | (x->y in link and y->x in link) implies x not in Trash and y not in Trash -- all x,y :File | (x->y in link) implies x not in Trash and y not in Trash  --incorrect 37
