...
--  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 40
  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u : User | some (Work<:source).u or some (Work<:source).Institution   --incorrect 42
