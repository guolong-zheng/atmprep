...
--  all w:Work | (w in User.profile) implies (w.source = User )   --incorrect 36
  all u:User , w:Work | (w in u.profile) implies (w.source = u )  --  all u : User | some w : Work | u->w in profile implies (Institution in w.source or User in w.source)  --incorrect 38
