...
--all u:User, w:Work | w in u.profile implies (u in w.source or some i:Institution | i in w.source) --correct
  all u : User, w : Work | u->w in profile implies (u.source in User or u.source in Institution) --  all u : User | some (u<:profile).Work implies some u.(Work<:source) & Institution.(Work<:source)    --incorrect 2
