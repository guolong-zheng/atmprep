...
--  all u:User ,i:Institution | u.profile.source = u  --incorrect 3
  all u : User| some w : Work | u->w in profile implies (w.source in User or w.source in Institution) --  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution     --incorrect 5
