...
--  all x, y : Work | no x.ids & y.ids  --incorrect 45
  all w1, w2:Work, u:User | ((w1 in u.profile and w2 in u.profile) and (w1.source = w2.source)) implies no (w1.ids & w2.ids) --  all u: User, w1, w2: u.profile, i: w1.ids | i not in w2.ids  --incorrect 47
