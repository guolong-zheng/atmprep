...
--  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution   --incorrect 24
  all u : User | some (u<:profile).Work implies some (Work<:source).u & (Work<:source).Institution  --  all u:User , w:Work, i:Institution | w in u.profile && (w.source = u || w.source = i)  --incorrect 26
