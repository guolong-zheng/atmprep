...
--  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 16
  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution  --  all u : User | some (u<:profile).Work implies some (Work<:source).u or some (Work<:source).Institution   --incorrect 18
