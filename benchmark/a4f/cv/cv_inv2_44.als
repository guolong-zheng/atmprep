...
--  all u : User | some (u<:profile).Work implies some (Work<:source).u + (Work<:source).Institution   --incorrect 43
  all u:User,w:Work | some i:Institution | w in u.profile implies (w.source = i or w.source = u) --  all u : User | Work.(u<:profile) in (Work<:source).u & (Work<:source).Institution   --incorrect 45
