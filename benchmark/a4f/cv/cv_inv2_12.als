...
--  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution    --incorrect 11
  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution  --  all u:User, w:Work, i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 13
