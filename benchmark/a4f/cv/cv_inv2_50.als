...
--  all u : User | Work.(u<:profile) in u.(Work<:source) + (Work<:source).Institution     --incorrect 49
  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution  --  all u:User, w:Work, i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 51
