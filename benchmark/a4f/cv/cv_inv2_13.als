...
--  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution   --incorrect 12
  all u:User, w:Work, i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u : User, w : Work | u->w in profile implies (w.source in User or w.source in Institution)  --incorrect 14
