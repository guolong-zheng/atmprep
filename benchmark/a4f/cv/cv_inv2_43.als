...
--  all u : User | some (Work<:source).u or some (Work<:source).Institution   --incorrect 42
  all u : User | some (u<:profile).Work implies some (Work<:source).u + (Work<:source).Institution  --  all u:User,w:Work | some i:Institution | w in u.profile implies (w.source = i or w.source = u)  --incorrect 44
