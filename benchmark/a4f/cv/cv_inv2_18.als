...
--  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution   --incorrect 17
  all u : User | some (u<:profile).Work implies some (Work<:source).u or some (Work<:source).Institution  --  all u:User , w:Work, i:Institution | w in u.profile && w.source = u || w.source = i  --incorrect 19
