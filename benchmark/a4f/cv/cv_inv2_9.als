...
--  all w : Work | w.source in Source  --incorrect 8
  all u:User , w:Work |some i:Institution| (w in u.profile) implies (w.source = u || w.source = i)  --  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution  --incorrect 10
