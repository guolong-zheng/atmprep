...
--  all u:User, w:Work | some i:Institution | w in u.profile implies u in w.source or i in w.source  --incorrect 23
  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution  --  all u : User | some (u<:profile).Work implies some (Work<:source).u & (Work<:source).Institution   --incorrect 25
