...
--  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 41
  all u : User | some (Work<:source).u or some (Work<:source).Institution  --  all u : User | some (u<:profile).Work implies some (Work<:source).u + (Work<:source).Institution   --incorrect 43
