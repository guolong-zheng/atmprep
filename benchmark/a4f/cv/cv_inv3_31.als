...
--  all w1, w2 : Work | some u : User | w1 != w2 and (w1 + w2) in u.profile implies no w1.ids & w2.ids  --incorrect 30
  all w1, w2 : Work | some u : User | w1 != w2 and (w1 + w2) in u.profile and (w1.source = w2.source) implies no w1.ids & w2.ids --  all w1,w2:Work | w1.ids = w2.ids implies w1 = w2  --incorrect 32
