...
--  all w1, w2:Work, u:User | ((w1 in u.profile and w2 in u.profile) and (w1.ids = w2.ids)) implies w1=w2  --incorrect 35
  all w1, w2 : Work | some u : User, s : Source | w1 != w2 and (w1 + w2) in u.profile and (w1.source = w2.source) implies no w1.ids & w2.ids --  all u: User, w1, w2: u.profile | all i: w1.ids | i not in w2.ids  --incorrect 37
