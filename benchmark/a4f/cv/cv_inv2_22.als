...
--  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution   --incorrect 21
  all u : User | (Work<:source).u in (Work<:source).Institution  --  all u:User, w:Work | some i:Institution | w in u.profile implies u in w.source or i in w.source  --incorrect 23
