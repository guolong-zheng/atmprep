...
--  all u : User | (Work<:source).u in (Work<:source).Institution   --incorrect 22
  all u:User, w:Work | some i:Institution | w in u.profile implies u in w.source or i in w.source --  all u : User | (u<:profile).Work in (Work<:source).u + (Work<:source).Institution   --incorrect 24
