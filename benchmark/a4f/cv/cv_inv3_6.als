...
--  all w:Work, w1:Work | (w in User.profile && w1 in User.profile) implies no (w.ids & w1.ids)  --incorrect 5
  all u: User | all w1, w2: u.profile | not w1.ids = w2.ids --  all w1, w2:Work, u:User | ((w1 in u.profile and w2 in u.profile) and (w1.ids = w2.ids) and (w1.source = w2.source)) implies no (w1.ids & w2.ids)  --incorrect 7
