...
--  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution   --incorrect 50
  all u:User, w:Work, i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u : User | some (u<:profile).Work implies some (Work<:source).u & (Work<:source).Institution   --incorrect 52
