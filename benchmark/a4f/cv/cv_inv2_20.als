...
--  all u:User , w:Work, i:Institution | w in u.profile && w.source = u || w.source = i  --incorrect 19
  all u:User, w:Work | w in u.profile implies (some i:Institution | u in w.source or i in w.source) --  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution   --incorrect 21
