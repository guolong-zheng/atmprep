...
--  all u : User | some (u<:profile).Work implies some (Work<:source).u or some (Work<:source).Institution   --incorrect 18
  all u:User , w:Work, i:Institution | w in u.profile && w.source = u || w.source = i --  all u:User, w:Work | w in u.profile implies (some i:Institution | u in w.source or i in w.source)  --incorrect 20
