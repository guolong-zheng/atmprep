...
--  all u : User, w : Work | u->w in profile implies (w.source in User or w.source in Institution)  --incorrect 14
  all w:Work | (w in User.profile) implies (User = w.source)  --  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 16
