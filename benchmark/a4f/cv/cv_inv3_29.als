...
--  all x, y : Work | x.ids != y.ids  --incorrect 28
  all w:Work, w1:Work | (w in User.profile && w1 in User.profile) implies no (w.ids & w1.ids) --  all w1, w2 : Work | some u : User | w1 != w2 and (w1 + w2) in u.profile implies no w1.ids & w2.ids  --incorrect 30
