...
--  all u:User , w:Work | (w in u.profile) implies (w.source = u || w.source = Institution)   --incorrect 54
  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution --  all u:User, w:Work, i:Institution | w in u.profile implies (u in w.source || i in w.source)  --incorrect 56
