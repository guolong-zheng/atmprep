...
--  all w:Work | (w in User.profile) && (User = w.source)   --incorrect 57
  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u:User, w:Work, i:Institution | w in u.profile implies u in w.source or i in w.source  --incorrect 59
