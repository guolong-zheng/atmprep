...
--  all w:Work | (w in User.profile) implies (User = w.source)   --incorrect 15
  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u : User | Work.(u<:profile) in (Work<:source).u + (Work<:source).Institution   --incorrect 17
