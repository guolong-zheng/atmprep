...
--  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 39
  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source) --  all u:User, w:Work | some i:Institution | w in u.profile implies (u in w.source or i in w.source)  --incorrect 41
