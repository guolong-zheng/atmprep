...
-- all t:Teacher,s:Student | s->t not in Tutors and t->t not in Tutors  --incorrect 19
 all t:Teacher,s:Student | s->t not in Tutors and t->t not in Tutors and s->t not in Tutors -- all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors  --incorrect 21
