...
-- all c : Class, t : Teacher, g : Group | c->t in Teaches implies c->t->g in Groups  --incorrect 62
 all c : Class, t, s : Person, g : Group | (t -> c not in Teaches) implies c -> s -> g not in Groups  -- all c : Class, t: Teacher | t->c in Teaches implies some s:Student,g:Group | c->s->g in Groups  --incorrect 64
