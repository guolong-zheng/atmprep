...
-- all c:Class , t:Teacher, s:Student, g:Group|(t->c in Teaches and c->s->g in Groups) implies t->s in Tutors  --incorrect 25
 all c:Class,s:Student | s in (c.Groups).Group -- all c:Class,s:Student | s in (c.Groups).Group implies some t:Teacher | t->c in Teaches and t in s.^~Tutors  --incorrect 27
