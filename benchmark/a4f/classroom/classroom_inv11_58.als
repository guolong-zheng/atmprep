...
-- all c : Class, s : Student, g : Group | some t : Teacher | t->c in Teaches  implies c->s->g in Groups  --incorrect 57
 all c : Class, t : Person | (t -> c in Teaches) implies (all p : Person, g : Group | c -> p -> g in Groups) -- all c : Class, t : Person | (t -> c not in Teaches) implies (all p : Person, g : Group | c -> p -> g not in Groups)  --incorrect 59
