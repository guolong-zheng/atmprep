...
-- all c: Class, g: Group, s: Student, t: Teacher | c->s->g in Groups implies t->c in Teaches  --incorrect 79
 all c: Class, s: Student, g: Group | some t: Teacher | (c->t not in Teaches) implies c->s->g not in Groups -- all c: Class, s:Student, g: Group | some t: Teacher | (c->t not in Teaches) implies c->s->g not in Groups  --incorrect 81
