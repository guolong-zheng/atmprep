...
--	Tutors.Person in Teacher and Person.Tutors in Student --correct
 all p:Person,t:Teacher,s:Student | s->p not in Tutors and p->t not in Tutors -- all p:Person,t:Teacher,s:Student | s->p not in Tutors and p->t not in Tutors and t->s in Tutors  --incorrect 2
