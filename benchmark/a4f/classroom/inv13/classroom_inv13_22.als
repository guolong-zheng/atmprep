...
-- all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors  --incorrect 21
 all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors and not s->c in Teaches -- all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors and s->c not in Teaches  --incorrect 23
