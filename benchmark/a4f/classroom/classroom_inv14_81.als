...
-- all s : Student | some t : Teacher, c : Class | t->c in Teaches implies t->s in Tutors  --incorrect 80
 all s : Student | some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches -- all s : Student | some t : Teacher, c : Class | t->s in Tutors implies s in Class and t in Class  --incorrect 82
