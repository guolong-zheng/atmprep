...
-- all c : Class | lone Teacher -> c & Teaches  --incorrect 2
 all c1,c2:Class | some t:Teacher | t->c1 in Teaches and t->c2 in Teaches implies c1=c2 -- all c:Class | (some t1:Teacher , t2:Teacher | (t1->c in Teaches and t2->c in Teaches) implies t1 = t2)  --incorrect 4
