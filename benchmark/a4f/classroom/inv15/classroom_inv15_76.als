...
-- some Teacher & ^Tutors.Person  --incorrect 75
 some x, y, z : Person | x->y in Tutors and y->z in Tutors and x != y and x != z and y != z implies z in Teacher -- some x, y, z : Person | x->y in Tutors and y->z in Tutors implies z in Teacher  --incorrect 77
