...
-- all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors implies x in Teacher  --incorrect 55
 all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors implies z in Teacher -- all x, y, z : Person | x->y in Tutors and y->z in Tutors implies z in Teacher  --incorrect 57
