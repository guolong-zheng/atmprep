...
-- all p : Person | some p <: ^ Tutors  --incorrect 3
 all p : Person | some p2 : Person | p -> p2 in Tutors and p in Teacher -- all p : Person | some q : Person, t : Teacher | t->p in Tutors or (q->p in Tutors and t->q in Tutors) or (t->q in Tutors and q->p in Tutors and p->t in Tutors)  --incorrect 5
