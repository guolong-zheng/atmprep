...
-- all p : Person | some q,r : Person | (p->q in Tutors or q->p in Tutors or q->r in Tutors or r->q in Tutors       or r->p in Tutors or p->r in Tutors)  implies (p in Teacher or q in Teacher or r in Teacher)  --incorrect 8
 all p : Person | some q,r : Person | (q in Teacher or r in Teacher) and (q->p in Tutors or r->p in Tutors or r->q in Tutors) -- all p : Person | some t : Teacher | t->p in Tutors or (some q : Person | q->p in Tutors and t->q in Tutors)  --incorrect 10
