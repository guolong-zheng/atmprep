...
-- all c: Class | some Groups implies some Teaches.c :> Teacher  --incorrect 68
 all c: Class | some s: Student, t: Teacher, g: Group | c->s->g in Groups implies t->c in Teaches -- all c: Class | some t :Teacher | t->c in Teaches and some c.Groups  --incorrect 70
