...
-- all g:Group,c:Class | some t:Teacher | c->t->g in Groups   --incorrect 226
 all p:Person, c:Class | (some t:Teacher, g:Group | c->p->g in Groups implies t->c in Teaches) -- all p:Person, c:Class, g:Group | (some t:Teacher | c->p->g in Groups implies t->c in Teaches)  --incorrect 228
