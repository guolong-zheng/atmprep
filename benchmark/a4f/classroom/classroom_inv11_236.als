...
-- all x : Class | some y : Person, z : Group, v : Teacher | x->y->z in Groups implies v->x in Teaches  --incorrect 235
 all x : Class | some y : Teacher | some g : Group | x->y->g in Groups -- not all c : Class, t : Teacher | (t -> c not in Teaches) implies (all p : Person, g : Group | c -> p -> g not in Groups)  --incorrect 237
