...
-- all x : Class | some y : Person | some g : Group | x->y->g in Groups implies y in Teacher  --incorrect 234
 all x : Class | some y : Person, z : Group, v : Teacher | x->y->z in Groups implies v->x in Teaches -- all x : Class | some y : Teacher | some g : Group | x->y->g in Groups  --incorrect 236
