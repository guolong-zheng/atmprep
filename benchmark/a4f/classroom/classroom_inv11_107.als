...
-- all c:Class | some g:Group, t:Teacher | t->c in Teaches implies c->t->g in Groups  --incorrect 106
 all c:Class | some g:Group, t:Teacher,p:Person | c->p->g in Groups implies c in t.Teaches -- all c:Class | some g:Group, t:Teacher,p:Person | c->p->g in Groups implies t->c in Teaches  --incorrect 108
