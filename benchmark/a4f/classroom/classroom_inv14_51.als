...
-- all p : Person | some c : Class, g : Group | c->p->g in Groups implies p->c in Teaches  --incorrect 50
 all p : Person | some c : Class, g : Group | c->p->g in Groups implies some q : Person | q->c in Teaches -- all p : Person | some c : Class, g : Group | c->p->g in Groups implies some q : Person | q->c in Teaches and q->p in Tutors  --incorrect 52
