...
-- all s, t : Person | some s.(Class.Groups) and some t<:Teaches implies some (t<:Tutors).s  --incorrect 113
 all s, t : Person | some s.(Class.Groups) and some t<:Teaches implies some t<:(Tutors.s) -- all s, t : Person, c : Class | (some g : Group | c->s->g in Groups) and t->s in Teaches implies t->c in Tutors  --incorrect 115
