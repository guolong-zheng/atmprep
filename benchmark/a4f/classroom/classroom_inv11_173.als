...
-- all c:Class,g:Group | some t:Teacher,s:Student | s in c.Groups.g implies t->c in Teaches and t->g in c.Groups   --incorrect 172
 all c:Class,g:Group |some p:Person,t:Teacher | p->g in c.Groups implies c->t->g in Groups -- all c:Class,g:Group |some p:Person,t:Teacher | p->g in c.Groups implies p in c.~Teaches  --incorrect 174
