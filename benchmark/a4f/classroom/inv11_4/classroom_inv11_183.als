...
-- all c:Class,g:Group,p:Person |some t:Teacher| c->p->g in Groups implies c->t->g in Groups  --incorrect 182
 all c:Class,g:Group,p:Person |some t:Teacher| c->p->g in Groups implies c->t->g in Groups and t->c in Teaches -- all c:Class,g:Group,s:Student | some t:Teacher | ( c->s->g in Groups) implies t->c in Teaches  --incorrect 184
