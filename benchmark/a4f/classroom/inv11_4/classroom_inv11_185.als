...
-- all c:Class,g:Group,s:Student | some t:Teacher | ( c->s->g in Groups) implies t->c in Teaches  --incorrect 184
 all c:Class,g:Group,t:Teacher | c->g->t in Groups implies t->c in Teaches -- all c:Class,g:Group,t:Teacher | c->t->g in Groups implies t->c in Teaches  --incorrect 186
