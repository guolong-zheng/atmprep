...
-- all c:Class,p:Person | some t:Teacher | some c.Groups.p implies t->c in Teaches  --incorrect 196
 all c:Class,s:Student | all g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches        -- all c:Class,s:Student | all g:Group |some t:Teacher| c->s->g in Groups implies t->c in Teaches  --incorrect 198           
