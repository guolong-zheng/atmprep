...
-- all c:Class,g:Group |some t:Teacher | some c.Groups.Person   --incorrect 177
 all c:Class,g:Group |some t:Teacher | some c.Groups.Person implies c->t->g in Groups -- all c:Class,g:Group,p:Person | some t:Teacher | c->t->g in Groups   --incorrect 179
