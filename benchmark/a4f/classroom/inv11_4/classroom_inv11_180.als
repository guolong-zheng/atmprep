...
-- all c:Class,g:Group,p:Person | some t:Teacher | c->t->g in Groups   --incorrect 179
 all c:Class,g:Group,p:Person | some t:Teacher | c->t->g in Groups implies t->c in Teaches -- all c:Class,g:Group,p:Person |some t:Teacher | c->p->g in Groups implies c->t->g in Groups  --incorrect 181
