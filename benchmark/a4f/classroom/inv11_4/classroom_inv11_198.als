...
-- all c:Class,s:Student | all g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches         --incorrect 197
 all c:Class,s:Student | all g:Group |some t:Teacher| c->s->g in Groups implies t->c in Teaches -- all c:Class,s:Student | some g:Group | c->s->g in Groups  --incorrect 199
