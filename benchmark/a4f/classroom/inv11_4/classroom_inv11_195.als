...
-- all c:Class,g:Group|some t:Teacher | t in c.Groups.g   --incorrect 194
 all c:Class,g:Group|some t:Teacher | t in c.Groups.g implies t->c in Teaches -- all c:Class,p:Person | some t:Teacher | some c.Groups.p implies t->c in Teaches  --incorrect 196
