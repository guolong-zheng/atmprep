...
-- all c:Class,g:Group|some t:Teacher | some c.Groups implies c->t->g in Groups and t->c in Teaches  --incorrect 192
 all c:Class,g:Group|some t:Teacher | some c.Groups.g implies c->t->g in Groups and t->c in Teaches -- all c:Class,g:Group|some t:Teacher | t in c.Groups.g   --incorrect 194
