...
-- all c:Class,g:Group|some t:Teacher | t in c.Groups.g implies t->c in Teaches  --incorrect 195
 all c:Class,p:Person | some t:Teacher | some c.Groups.p implies t->c in Teaches -- all c:Class,s:Student | all g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches         --incorrect 197
