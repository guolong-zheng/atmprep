...
-- all c:Class,g:Group | some t:Teacher | some c.Groups   --incorrect 164
 all c:Class,g:Group | some t:Teacher | some c.Groups.g implies c->t->g in Groups -- all c:Class,g:Group | some t:Teacher | some c.Groups.g implies c->t->g in Groups   --incorrect 166
