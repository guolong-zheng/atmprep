...
-- all c:Class,g:Group | some t:Teacher | some c.Groups.g implies t->c in Teaches  --incorrect 169
 all c:Class,g:Group | some t:Teacher | some c.Groups.g implies t->c in Teaches and t->g in c.Groups  -- all c:Class,g:Group | some t:Teacher,s:Student | ( c->s->g in Groups) implies t->c in Teaches  --incorrect 171
