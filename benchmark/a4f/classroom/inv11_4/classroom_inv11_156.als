...
-- all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups implies c in t.Teaches  --incorrect 155
 all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups implies c->t->g in Groups -- all c:Class,g:Group | some t:Teacher | c in Class implies c->t->g in Groups  --incorrect 157
