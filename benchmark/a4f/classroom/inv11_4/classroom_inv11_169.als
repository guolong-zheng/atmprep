...
-- all c:Class,g:Group | some t:Teacher | some c.Groups.g implies c->t->g in Groups and t->c in Teaches  --incorrect 168
 all c:Class,g:Group | some t:Teacher | some c.Groups.g implies t->c in Teaches -- all c:Class,g:Group | some t:Teacher | some c.Groups.g implies t->c in Teaches and t->g in c.Groups   --incorrect 170
