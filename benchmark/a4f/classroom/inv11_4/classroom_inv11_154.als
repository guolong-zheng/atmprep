...
-- all c:Class,g:Group | some p:Person | c->p->g in Groups implies p in Teacher  --incorrect 153
 all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups -- all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups implies c in t.Teaches  --incorrect 155
