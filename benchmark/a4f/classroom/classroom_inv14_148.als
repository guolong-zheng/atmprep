...
-- all s:Student,c:Class,t:Teacher | s in c.Groups.Group  --incorrect 147
 all s:Student,c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches -- all s:Student,c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches implies t in s.^~Tutors  --incorrect 149
