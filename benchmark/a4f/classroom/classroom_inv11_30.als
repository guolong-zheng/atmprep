...
-- all c : Class | some p : Person, g : Group | c->p->g in Groups implies some t : Teacher |  t->c in Teaches   --incorrect 29
 all c : Class | some p : Person, g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class | some p : Person, g : Group, t : Teacher | c->p->g in Groups implies t->c in Teaches   --incorrect 31
