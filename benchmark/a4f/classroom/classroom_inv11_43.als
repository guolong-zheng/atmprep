...
-- all c : Class | some t : Teacher | some s : Student | some g : Group | c->s->g in Groups and t->c in Teaches  --incorrect 42
 all c : Class | some t : Teacher | some s : Student | some g : Group | c->s->g in Groups implies t->c in Teaches -- all c : Class | some t : Teacher | some s : Student | some g : Group | t->c in Teaches implies c->s->g in Groups  --incorrect 44
