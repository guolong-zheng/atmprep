...
-- all s : Student, c : Class, t : Teacher, g : Group | (c -> s -> g in Groups) and t -> c in Teaches implies t -> s in Tutors  --incorrect 106
 all s : Student, t : Teacher | (some s.(Class.Groups)) implies some t.(Class.Groups) -- all s : Student, t : Teacher | some s.(Class.Groups) and some (t<:Teaches).Class implies some (t<:Tutors).s  --incorrect 108
