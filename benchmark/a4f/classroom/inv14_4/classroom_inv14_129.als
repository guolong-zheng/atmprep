...
-- all s:Student,c:Class | s in c.Groups.Group  --incorrect 128
 all s:Student,c:Class | s in c.Groups.Group implies some t:Teacher | t->c in Teaches -- all s:Student,c:Class | s in c.Groups.Group implies some t:Teacher | t->c in Teaches and t in s.^~Tutors  --incorrect 130
