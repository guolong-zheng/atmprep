...
-- all s : Student, t : Teacher, c : Class | some s.(c<:Groups) and some (t<:Teaches).c implies some (t<:Tutors).s  --incorrect 111
 all s, t : Person | some s.(Class.Groups) and some t<:(Teaches.Class) implies some t<:(Tutors.s) -- all s, t : Person | some s.(Class.Groups) and some t<:Teaches implies some (t<:Tutors).s  --incorrect 113
