...
-- some (Teacher<:Teaches).Groups  --incorrect 85
 some c : Class | (some p : Person, g : Group | c->p->g in Groups) implies all t : Teacher | t->c in Teaches -- some c : Class | (some p : Person, g : Group | c->p->g in Groups) implies some t : Teacher | t->c in Teaches  --incorrect 87
