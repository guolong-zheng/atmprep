...
-- all t : Teacher, c : Class | t->c in Teaches  --incorrect 39
 all t : Teacher, c : Class | t->c in Teaches implies some p : Person | all g : Group | c->p->g in Groups -- all t : Teacher, c : Class | t->c in Teaches implies some p : Person, g : Group | c->p->g in Groups  --incorrect 41
