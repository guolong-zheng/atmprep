...
-- all s:Student,c:Class,g:Group|some t:Teacher | some Teacher  --incorrect 144
 all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups) -- all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups) implies t in s.^~Tutors  --incorrect 146
