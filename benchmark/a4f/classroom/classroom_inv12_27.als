...
-- all t : Teacher | some c : Class, g : Group | c->t->g in Groups implies t->c in Teaches  --incorrect 26
 all t : Teacher | some c : Class, g : Group | t->c in Teaches and c->t->g in Groups  -- all t : Teacher | some c : Class, g : Group | t->c in Teaches implies c->t->g in Groups   --incorrect 28
