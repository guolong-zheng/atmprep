...
-- all s:Student, t:Teacher | s not in Person.^Tutors and t not in Person.^Tutors  --incorrect 6
 all s:Student, t:Teacher | s not in Person.^Tutors and t not in Person.^~Tutors -- all s:Student, t:Teacher | s not in Person.^Tutors and t not in Person.Tutors  --incorrect 8
