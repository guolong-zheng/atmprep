...
-- all c : Class | some p : Person, g : Group, t :Teacher | c->t->g in Groups implies c->t in Teaches   --incorrect 32
 all c : Class | some s : Person, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class | some s : Student | all g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches)  --incorrect 34
