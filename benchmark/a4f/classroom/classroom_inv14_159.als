...
-- all s:Student| some c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches implies t in s.^~Tutors  --incorrect 158
 all s:Student| some t:Teacher | t->s in Tutors -- all s:Student| some t:Teacher,c:Class,g:Group | t->s in Tutors and c->s->g in Groups and c->t->g in Groups  --incorrect 160
