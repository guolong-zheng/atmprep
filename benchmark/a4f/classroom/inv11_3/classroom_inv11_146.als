...
-- all c:Class, t:Teacher , s:Student|some g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 145
 all c:Class, t:Teacher, g:Group | c->t->g in Groups implies t->c in Teaches -- all c:Class, t:Teacher, g:Group | t->c in Teaches implies c->t->g in Groups  --incorrect 147
