...
-- all c:Class, g:Group | some c.Groups  --incorrect 136
 all c:Class, g:Group | some p:Person | c->p->g in Groups implies p in Teacher                -- all c:Class, g:Group |some t:Teacher | t->c in Teaches implies c->t->g in Groups  --incorrect 138
