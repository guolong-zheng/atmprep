...
-- all c:Class | some t:Teacher,g:Group | c->t->g in Groups   --incorrect 130
 all c:Class | some t:Teacher,g:Group | some c.Groups  -- all c:Class | some t:Teacher,g:Group | some c.Groups.g implies c->t->g in Groups and t->c in Teaches  --incorrect 132
