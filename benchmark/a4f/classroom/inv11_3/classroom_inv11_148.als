...
-- all c:Class, t:Teacher, g:Group | t->c in Teaches implies c->t->g in Groups  --incorrect 147
 all c:Class, t:Teacher, g:Group | t->c in Teaches implies c->t->g in Groups   -- all c:Class, t:Teacher, g:Group | t->c not in Teaches implies c->t->g not in Groups  --incorrect 149
