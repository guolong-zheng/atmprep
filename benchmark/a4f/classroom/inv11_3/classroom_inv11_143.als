...
-- all c:Class, s:Student|some t:Teacher, g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 142
 all c:Class, t:Teacher , s:Student, g:Group| t->c in Teaches implies c->s->g in Groups -- all c:Class, t:Teacher , s:Student| some g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 144
