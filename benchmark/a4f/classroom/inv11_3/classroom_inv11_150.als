...
-- all c:Class, t:Teacher, g:Group | t->c not in Teaches implies c->t->g not in Groups  --incorrect 149
 all c:Class, t:Teacher, g:Group, p:Person | t->c not in Teaches implies c->p->g in Groups   -- all c:Class, t:Teacher, g:Group, p:Person | t->c not in Teaches implies c->p->g not in Groups  --incorrect 151
