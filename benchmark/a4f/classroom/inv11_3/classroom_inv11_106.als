...
-- all c:Class | some g:Group, t:Teacher | c->t->g in Groups  --incorrect 105
 all c:Class | some g:Group, t:Teacher | t->c in Teaches implies c->t->g in Groups -- all c:Class | some g:Group, t:Teacher,p:Person | c->p->g in Groups implies c in t.Teaches  --incorrect 107
