...
-- all c:Class | some t:Teacher | some c.Groups implies t->c in Teaches  --incorrect 123
 all c:Class | some t:Teacher | some c.Groups.Group implies c in t.Teaches  -- all c:Class | some t:Teacher | some c.Groups.Group implies t->c in Teaches  --incorrect 125
