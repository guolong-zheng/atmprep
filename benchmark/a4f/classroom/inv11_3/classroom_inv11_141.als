...
-- all c:Class, p:Person, g:Group | p->c not in Teaches implies c->p->g not in Groups  --incorrect 140
 all c:Class, s:Student, g:Group|some t:Teacher | t->c in Teaches implies c->s->g in Groups -- all c:Class, s:Student|some t:Teacher, g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 142
