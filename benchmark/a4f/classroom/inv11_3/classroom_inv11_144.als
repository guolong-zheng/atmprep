...
-- all c:Class, t:Teacher , s:Student, g:Group| t->c in Teaches implies c->s->g in Groups  --incorrect 143
 all c:Class, t:Teacher , s:Student| some g:Group | t->c in Teaches implies c->s->g in Groups -- all c:Class, t:Teacher , s:Student|some g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 145
