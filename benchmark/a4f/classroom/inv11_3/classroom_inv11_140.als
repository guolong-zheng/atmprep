...
-- all c:Class, p : Person, g:Group | c->p->g in Groups implies p in Teacher                 --incorrect 139
 all c:Class, p:Person, g:Group | p->c not in Teaches implies c->p->g not in Groups -- all c:Class, s:Student, g:Group|some t:Teacher | t->c in Teaches implies c->s->g in Groups  --incorrect 141
