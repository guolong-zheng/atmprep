...
-- all c:Class | some t:Teacher | some c.Groups.Group implies t->c in Teaches  --incorrect 125
 all c:Class | some t:Teacher | some c.Groups.Person implies t->c in Teaches -- all c:Class | some t:Teacher | some c.Groups.t implies c in t.Teaches   --incorrect 127
