...
-- all c:Class | some t:Teacher | some c.Groups.Group implies c in t.Teaches   --incorrect 124
 all c:Class | some t:Teacher | some c.Groups.Group implies t->c in Teaches -- all c:Class | some t:Teacher | some c.Groups.Person implies t->c in Teaches  --incorrect 126
