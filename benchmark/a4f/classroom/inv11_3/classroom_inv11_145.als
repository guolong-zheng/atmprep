...
-- all c:Class, t:Teacher , s:Student| some g:Group | t->c in Teaches implies c->s->g in Groups  --incorrect 144
 all c:Class, t:Teacher , s:Student|some g:Group | t->c in Teaches implies c->s->g in Groups -- all c:Class, t:Teacher, g:Group | c->t->g in Groups implies t->c in Teaches  --incorrect 146
