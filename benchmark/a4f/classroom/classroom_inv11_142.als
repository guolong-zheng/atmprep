...
-- all c:Class, s:Student, g:Group|some t:Teacher | t->c in Teaches implies c->s->g in Groups  --incorrect 141
 all c:Class, s:Student|some t:Teacher, g:Group | t->c in Teaches implies c->s->g in Groups -- all c:Class, t:Teacher , s:Student, g:Group| t->c in Teaches implies c->s->g in Groups  --incorrect 143
