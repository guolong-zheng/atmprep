...
-- all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors and x != y and x != z and y != z implies x in Teacher  --incorrect 54
 all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors implies x in Teacher -- all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors implies z in Teacher  --incorrect 56
