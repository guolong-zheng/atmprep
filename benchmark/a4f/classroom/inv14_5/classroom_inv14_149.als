...
-- all s:Student,c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches  --incorrect 148
 all s:Student,c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches implies t in s.^~Tutors -- all s:Student,c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches implies t in s.~Tutors  --incorrect 150
