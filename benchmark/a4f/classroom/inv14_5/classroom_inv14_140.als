...
-- all s:Student,c:Class, t:Teacher | t->c in Teaches and one s.(c.Groups) and one t.(c.Groups) implies t in s.^Tutors  --incorrect 139
 all s:Student,c:Class,g:Group | some t:Teacher |(t->s in Tutors and c->s->g in Groups) implies t->c in Teaches -- all s:Student,c:Class,g:Group|some t:Teacher | some c.Groups  --incorrect 141
