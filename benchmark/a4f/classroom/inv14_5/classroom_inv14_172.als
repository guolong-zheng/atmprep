...
-- all x : Person, y : Class, v : Teacher | (some z : Group | y->x->z in Groups) and v->y in Teaches implies v->y in Tutors  --incorrect 171
 all x, v : Person, y : Class | (some z : Group | y->x->z in Groups) and v->y in Teaches implies v->x in Tutors -- Class in (Teacher<:Teaches).Class implies Student in (Teacher<:Tutors).Student  --incorrect 173
