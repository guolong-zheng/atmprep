...
-- all s:Student,c:Class | some t:Teacher | some s.(c.Groups) and some t.(c.Groups) implies t in s.^~Tutors  --incorrect 137
 all s:Student,c:Class | some t:Teacher | t->s in Tutors -- all s:Student,c:Class, t:Teacher | t->c in Teaches and one s.(c.Groups) and one t.(c.Groups) implies t in s.^Tutors  --incorrect 139
