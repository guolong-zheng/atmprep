...
-- all x : Person, y : Class, v : Teacher | ((some z : Group | y->x->z in Groups) and v->y in Teaches) implies v->x in Tutors  --incorrect 167
 all x : Person, y : Class, v : Teacher | (all z : Group | y->x->z in Groups) and v->y in Teaches implies v->x in Tutors -- all x : Person, y : Class, v : Teacher | (some z : Group | y->x->z in Groups) and v->y in Teaches  --incorrect 169
