...
-- all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups)  --incorrect 145
 all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups) implies t in s.^~Tutors -- all s:Student,c:Class,t:Teacher | s in c.Groups.Group  --incorrect 147
