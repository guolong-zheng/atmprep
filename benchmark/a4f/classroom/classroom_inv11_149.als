...
-- all c:Class, t:Teacher, g:Group | t->c in Teaches implies c->t->g in Groups    --incorrect 148
 all c:Class, t:Teacher, g:Group | t->c not in Teaches implies c->t->g not in Groups -- all c:Class, t:Teacher, g:Group, p:Person | t->c not in Teaches implies c->p->g in Groups    --incorrect 150
