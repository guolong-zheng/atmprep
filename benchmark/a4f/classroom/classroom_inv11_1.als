...
--	all c : Class | (some c.Groups) implies some Teacher & Teaches.c --correct
 all c : Class | (some c.Groups implies some (c.Teaches & Teacher)) -- all c : Class | (some g : Group, t : Teacher | c->t->g in Groups) implies some t : Teacher | t->c in Teaches  --incorrect 2
