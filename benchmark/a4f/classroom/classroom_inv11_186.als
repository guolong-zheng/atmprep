...
-- all c:Class,g:Group,t:Teacher | c->g->t in Groups implies t->c in Teaches  --incorrect 185
 all c:Class,g:Group,t:Teacher | c->t->g in Groups implies t->c in Teaches -- all c:Class,g:Group,t:Teacher,p:Person | c->p->g in Groups implies t->c in Teaches  --incorrect 187
