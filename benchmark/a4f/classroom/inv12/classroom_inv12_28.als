...
-- all t : Teacher | some c : Class, g : Group | t->c in Teaches and c->t->g in Groups   --incorrect 27
 all t : Teacher | some c : Class, g : Group | t->c in Teaches implies c->t->g in Groups  -- all t : Teacher | some c : Class, g : Group, t0 : Teacher | c->t->g in Groups and t0->c in Teaches  --incorrect 29
