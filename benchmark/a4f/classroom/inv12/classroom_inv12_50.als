...
-- all t:Teacher  | some t.Groups  --incorrect 49
 all t:Teacher , s:Student | (some g:Group ,c:Class| t->c in Teaches and c->s->g in Groups) -- all t:Teacher , s:Student | some g:Group ,c:Class| t->c in Teaches and c->s->g in Groups  --incorrect 51
