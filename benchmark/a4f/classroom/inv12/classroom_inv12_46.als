...
-- all t: Teacher | some g: Group, c: Class | c->t->g in Groups  --incorrect 45
 all t: Teacher | some g: Group, c: Class | t->c in Teaches implies (c->t->g in Groups) -- all t: Teacher|some c: Class | t->c in Teaches implies some s:Student, g:Group | c->s->g in Groups  --incorrect 47
