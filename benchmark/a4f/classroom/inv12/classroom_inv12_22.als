...
-- all t : Teacher | some c : Class | t->c in Teaches implies some p : Person | all g : Group | c->p->g in Groups  --incorrect 21
 all t : Teacher | some c : Class | t->c in Teaches implies some p : Person, g : Group | c->p->g in Groups -- all t : Teacher | some c : Class, g : Group | c->t->g in Groups  --incorrect 23
