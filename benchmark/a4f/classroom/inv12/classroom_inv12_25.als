...
-- all t : Teacher | some c : Class, g : Group | c->t->g in Groups   --incorrect 24
 all t : Teacher | some c : Class, g : Group | c->t->g in Groups and t->c in Teaches -- all t : Teacher | some c : Class, g : Group | c->t->g in Groups implies t->c in Teaches  --incorrect 26
