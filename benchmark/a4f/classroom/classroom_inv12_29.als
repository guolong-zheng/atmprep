...
-- all t : Teacher | some c : Class, g : Group | t->c in Teaches implies c->t->g in Groups   --incorrect 28
 all t : Teacher | some c : Class, g : Group, t0 : Teacher | c->t->g in Groups and t0->c in Teaches -- all t : Teacher | some c : Class, p : Person, g : Group | c->p->g in Groups implies t->c in Teaches   --incorrect 30
