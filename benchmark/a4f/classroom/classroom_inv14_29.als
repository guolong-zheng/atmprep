...
-- all c:Class,s:Student | s in c.Groups.Group  --incorrect 28
 all c:Class,s:Student,s:Teacher |some g:Group,t:Teacher| s in c.Groups.Group and c->t->g in Groups -- all c:Class,s:Student,t:Teacher | some s.(c.Groups)  --incorrect 30
