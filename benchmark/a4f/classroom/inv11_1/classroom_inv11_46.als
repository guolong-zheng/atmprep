...
-- all c : Class | some t : Teacher | t -> c not in Teaches implies (all p : Person, g : Group | c -> p -> g not in Groups)  --incorrect 45
 all c : Class | some t : Teacher | t -> c not in Teaches implies not (some p : Person, g : Group | c -> p -> g in Groups) -- all c : Class | some t : Teacher, g : Group | c->t in Teaches implies c->t->g in Groups  --incorrect 47
