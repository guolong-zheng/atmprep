...
-- all c : Class | some s : Student, g : Group, t : Teacher | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 37
 all c : Class | some s : Student, g : Group, t : Teacher | c->s->g in Groups implies t->c in Teaches -- all c : Class | some t : Teacher | ((t -> c not in Teaches) implies not (some p : Person, g : Group | c -> p -> g in Groups))  --incorrect 39
