...
-- all c : Class | some s : Person, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 33
 all c : Class | some s : Student | all g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches) -- all c : Class | some s : Student | some g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches)  --incorrect 35
