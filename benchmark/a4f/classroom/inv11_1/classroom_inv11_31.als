...
-- all c : Class | some p : Person, g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 30
 all c : Class | some p : Person, g : Group, t : Teacher | c->p->g in Groups implies t->c in Teaches  -- all c : Class | some p : Person, g : Group, t :Teacher | c->t->g in Groups implies c->t in Teaches   --incorrect 32
