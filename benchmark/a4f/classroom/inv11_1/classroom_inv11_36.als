...
-- all c : Class | some s : Student | some g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches)  --incorrect 35
 all c : Class | some s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class | some s : Student, g : Group, t : Teacher | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 37
