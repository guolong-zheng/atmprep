...
-- all c : Class | some p : Person | some g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 28
 all c : Class | some p : Person, g : Group | c->p->g in Groups implies some t : Teacher |  t->c in Teaches  -- all c : Class | some p : Person, g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 30
