...
-- all c : Class | some p : Person, g : Group, t : Teacher | c->p->g in Groups implies t->c in Teaches   --incorrect 31
 all c : Class | some p : Person, g : Group, t :Teacher | c->t->g in Groups implies c->t in Teaches  -- all c : Class | some s : Person, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 33
