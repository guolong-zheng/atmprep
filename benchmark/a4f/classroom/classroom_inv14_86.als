...
-- all s : Student | some t : Teacher, c : Class, g : Group | t->c in Teaches implies t->s in Tutors  --incorrect 85
 all s : Student | some t : Teacher, c : Class, g : Group | t->c in Teaches implies t->s in Tutors and c->s->g in Groups -- all s : Student | some Tutors.s & Groups.s.Group  --incorrect 87
