...
-- all c:Class,s:Student | some g:Group | c->s->g in Groups  --incorrect 199
 all c:Class,s:Student | some g:Group | c->s->g in Groups and some t:Teacher | t->c in Teaches -- all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups  --incorrect 201
