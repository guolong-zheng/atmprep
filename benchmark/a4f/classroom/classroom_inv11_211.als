...
-- all c:Class,t:Teacher | t.Teaches = c   --incorrect 210
 all c:Class,t:Teacher,s:Student | some g:Group | c->s->g in Groups implies t->c in Teaches -- all c:Class,t:Teacher,s:Student | some g:Group | s->c->g in Groups implies t->c in Teaches  --incorrect 212
