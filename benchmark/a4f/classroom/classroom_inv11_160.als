...
-- all c:Class,g:Group | some t:Teacher | c->t->g in Groups   --incorrect 159
 all c:Class,g:Group | some t:Teacher | c->t->g in Groups implies c in t.Teaches -- all c:Class,g:Group | some t:Teacher | c->t->g in Groups implies t->c in Teaches  --incorrect 161
