...
-- all t:Teacher,s:Student | s->t not in Tutors and t->s in Tutors  --incorrect 18
 all t:Teacher,s:Student | s->t not in Tutors and t->t not in Tutors -- all t:Teacher,s:Student | s->t not in Tutors and t->t not in Tutors and s->t not in Tutors  --incorrect 20
