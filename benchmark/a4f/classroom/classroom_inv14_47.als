...
-- all c:Class,s:Student|some g:Group| c->s->g in Groups  --incorrect 46
 all p : Person | some c : Class, g : Group | c->p->g in Groups and some q : Person | q->c in Teaches and q->p in Tutors -- all p : Person | some c : Class, g : Group | c->p->g in Groups and some q : Person | q->c in Teaches implies q->p in Tutors  --incorrect 48
