...
-- all c:Class | some c.Groups.Person   --incorrect 102
 all c:Class | some g:Group, p:Person | c->p->g in Groups implies p in Teacher -- all c:Class | some g:Group, t:Teacher | c->Person->g in Groups implies c in t.Teaches  --incorrect 104
