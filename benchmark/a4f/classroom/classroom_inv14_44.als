...
-- all c:Class,s:Student,t:Teacher|some g:Group| c->s->g in Groups and c->t->g in Groups  --incorrect 43
 all c:Class,s:Student| some t:Teacher | s in c.Groups.Group and t in c.Groups.Group implies t in s.^(~Tutors) -- all c:Class,s:Student| some t:Teacher | s in c.Groups.Group implies t in s.^(~Tutors)  --incorrect 45
