...
-- all s,t : Person, c : Class | some s.(c.Groups) and some (t.Teaches)  --incorrect 118
 all s,t : Person, c : Class | some s.(c.Groups) and some (t<:Teaches).c -- all s,t : Person, c : Class | some s.(c.Groups) and some (t<:Teaches).c implies some (t<:Tutors).s  --incorrect 120
