...
-- all s : Student | some s.(Class.Groups)  --incorrect 71
 all s : Student | some s.(Class.Groups)   implies some (Teacher<:Tutors).s -- all s : Student | some s.(Class.Groups) and some Teacher.Teaches implies some (Teacher<:Tutors).s  --incorrect 73
