...
-- all c:Class, g:Group |some t:Teacher | t->c in Teaches implies c->t->g in Groups  --incorrect 138
 all c:Class, p : Person, g:Group | c->p->g in Groups implies p in Teacher                -- all c:Class, p:Person, g:Group | p->c not in Teaches implies c->p->g not in Groups  --incorrect 140
