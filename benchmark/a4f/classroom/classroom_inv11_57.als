...
-- all c : Class, s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 56
 all c : Class, s : Student, g : Group | some t : Teacher | t->c in Teaches  implies c->s->g in Groups -- all c : Class, t : Person | (t -> c in Teaches) implies (all p : Person, g : Group | c -> p -> g in Groups)  --incorrect 58
