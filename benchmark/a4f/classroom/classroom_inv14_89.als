...
-- all s : Student, c : Class | some (Teacher<:Teaches).c implies some s.(Teacher<:Teaches)  --incorrect 88
 all s : Student, c : Class | some (Teacher<:Teaches).c implies some s.(Teacher<:Tutors) -- all s : Student, c : Class | some (Teacher<:Tutors).c implies some s.(Teacher<:Teaches)  --incorrect 90
