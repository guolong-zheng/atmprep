...
-- all c:Class,s:Student,t:Teacher | some s.(c.Groups)  --incorrect 30
 all c:Class,s:Student,t:Teacher | some s.(c.Groups) and some t.(c.Groups) -- all c:Class,s:Student,t:Teacher | some s.(c.Groups) and some t.(c.Groups) and t->c in Teaches implies t in s.^~Tutors  --incorrect 32
