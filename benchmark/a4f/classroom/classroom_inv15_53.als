...
-- all t:Teacher | all p:Person | t in p.^~Tutors  --incorrect 52
 all x, y, z : Person | x->y in Tutors and y->z in Tutors and x != y and x != z and y != z implies z in Teacher -- all x, y, z : Person | x->y in Tutors and y->z in Tutors and z->x in Tutors and x != y and x != z and y != z implies x in Teacher  --incorrect 54
