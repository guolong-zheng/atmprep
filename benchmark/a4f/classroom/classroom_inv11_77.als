...
-- all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies t->c in Teaches  --incorrect 76
 all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies t->c in Teaches and t != s  -- all c: Class, g: Group, s: Student, t: Teacher | c->s->g in Groups implies (t->c in Teaches and t != s)  --incorrect 78
