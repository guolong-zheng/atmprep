...
-- all c : Class, t : Teacher | (t -> c not in Teaches) implies not (some p : Person, g : Group | c -> p -> g in Groups)  --incorrect 61
 all c : Class, t : Teacher, g : Group | c->t in Teaches implies c->t->g in Groups -- all c : Class, t, s : Person, g : Group | (t -> c not in Teaches) implies c -> s -> g not in Groups   --incorrect 63
