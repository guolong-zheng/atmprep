...
-- all s:Student, t:Teacher | s not in Person.^Tutors and t not in Person.Tutors  --incorrect 8
 all s:Student, t:Teacher | s not in Person.Tutors.^Tutors and t not in Person.~Tutors.^~Tutors -- all s:Student,t:Teacher | s not in Person.^~Tutors and t not in Person.^Tutors  --incorrect 10
