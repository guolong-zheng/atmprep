...
-- all c: Class | some t :Teacher | t->c in Teaches and some c.Groups  --incorrect 70
 all c: Class | some t: Teacher , p: Person , g: Group| (c->p->g in Groups) implies (t->c in Teaches) -- all c: Class | some t: Teacher , p: Person , g: Group| c->p->g in Groups implies (t->c in Teaches)  --incorrect 72
