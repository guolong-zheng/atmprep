...
-- all c: Class, g: Group | some s: Student, t: Teacher | c->s->g in Groups implies t->c in Teaches  --incorrect 73
 all c: Class, g: Group | some t: Teacher , p: Person | c->p->g in Groups implies (t->c in Teaches) -- all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies (t->c in Teaches and t != s)  --incorrect 75
