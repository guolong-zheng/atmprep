...
-- all c : Class | some Teaches.c.Groups  --incorrect 52
 all c : Class, p : Person | some g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class, s : Student | some g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches)  --incorrect 54
