...
-- all c: Class | some Groups implies some Teaches.c  --incorrect 67
 all c: Class | some Groups implies some Teaches.c :> Teacher -- all c: Class | some s: Student, t: Teacher, g: Group | c->s->g in Groups implies t->c in Teaches  --incorrect 69
