...
-- all c : Class, t : Teacher | (t -> c not in Teaches) implies (all p : Person, g : Group | c -> p -> g not in Groups)  --incorrect 60
 all c : Class, t : Teacher | (t -> c not in Teaches) implies not (some p : Person, g : Group | c -> p -> g in Groups) -- all c : Class, t : Teacher, g : Group | c->t in Teaches implies c->t->g in Groups  --incorrect 62
