...
-- all c : Class, t: Teacher | t->c in Teaches implies some s:Student,g:Group | c->s->g in Groups  --incorrect 64
 all c : Class, t: Teacher | t->c not in Teaches implies not some s:Student,g:Group | c->s->g in Groups -- all c: Class | some c.Groups implies some Teaches.c  --incorrect 66
