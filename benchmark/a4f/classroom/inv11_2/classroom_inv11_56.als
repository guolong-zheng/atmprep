...
-- all c : Class, s : Student, g : Group | c->s->g in Groups implies (some t : Teacher | t->c in Teaches)  --incorrect 55
 all c : Class, s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class, s : Student, g : Group | some t : Teacher | t->c in Teaches  implies c->s->g in Groups  --incorrect 57
