...
-- all c:Class| some t:Teacher | some c.Groups implies c in t.Teaches  --incorrect 216
 all c:Class| some t:Teacher | some c.Groups.t implies c in t.Teaches -- all c:Class| some t:Teacher | some c.Groups.Teacher implies c in t.Teaches  --incorrect 218
