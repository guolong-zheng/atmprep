...
-- all c: Class, g: Group, s: Student, t: Teacher | c->s->g in Groups implies (t->c in Teaches and t != s)  --incorrect 78
 all c: Class, g: Group, s: Student, t: Teacher | c->s->g in Groups implies t->c in Teaches -- all c: Class, s: Student, g: Group | some t: Teacher | (c->t not in Teaches) implies c->s->g not in Groups  --incorrect 80
