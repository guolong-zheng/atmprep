...
-- all t:Teacher | some t.Teaches  --incorrect 23
 all x : Teacher | some y,z : Class  | (x->y in Teaches and x->z in Teaches) implies y=z -- all x : Teacher | some y,z : Class | x->y in Teaches and x->z in Teaches implies y=z  --incorrect 25
