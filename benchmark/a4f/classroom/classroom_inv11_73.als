...
-- all c: Class | some t: Teacher , p: Person , g: Group| c->p->g in Groups implies (t->c in Teaches)  --incorrect 72
 all c: Class, g: Group | some s: Student, t: Teacher | c->s->g in Groups implies t->c in Teaches -- all c: Class, g: Group | some t: Teacher , p: Person | c->p->g in Groups implies (t->c in Teaches)  --incorrect 74
