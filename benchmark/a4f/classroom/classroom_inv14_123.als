...
-- all s:Student | some t:Teacher | t in s.^~Tutors  --incorrect 122
 all s:Student, c:Class | some t:Teacher | t->s in Tutors implies t->c in Teaches -- all s:Student, c:Class, g:Group | some t:Teacher | (t->s in Tutors and c->s->g in Groups) implies t->c in Teaches  --incorrect 124
