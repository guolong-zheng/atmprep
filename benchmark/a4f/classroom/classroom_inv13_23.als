...
-- all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors and not s->c in Teaches  --incorrect 22
 all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors and s->c not in Teaches -- all t:Teacher,s:Student,p:Person | p->t not in Tutors and s->p not in Tutors  --incorrect 24
