...
-- all s:Student,t:Teacher,c:Class,g:Group | (t->s in Tutors and c->s->g in Groups) implies t->c in Teaches  --incorrect 157
 all s:Student| some c:Class,t:Teacher | s in c.Groups.Group and t->c in Teaches implies t in s.^~Tutors -- all s:Student| some t:Teacher | t->s in Tutors  --incorrect 159
