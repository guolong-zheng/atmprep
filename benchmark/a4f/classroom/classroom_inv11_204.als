...
-- all c:Class,s:Student,g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups  --incorrect 203
 all c:Class,s:Student,g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups   -- all c:Class,t:Teacher ,g:Group | t->c not in Teaches implies c->t->g not in Groups    --incorrect 205
