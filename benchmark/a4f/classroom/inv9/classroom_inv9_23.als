...
-- all c:Class | one Teacher.Teaches:>c  --incorrect 22
 all c:Class | some t1,t2:Teacher | t1->c in Teaches and t2->c in Teaches implies t1=t2 -- all c:Class |some t:Teacher | lone c.~Teaches and lone t.Teaches  --incorrect 24
