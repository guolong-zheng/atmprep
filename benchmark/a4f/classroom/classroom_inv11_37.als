...
-- all c : Class | some s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 36
 all c : Class | some s : Student, g : Group, t : Teacher | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- all c : Class | some s : Student, g : Group, t : Teacher | c->s->g in Groups implies t->c in Teaches  --incorrect 38
