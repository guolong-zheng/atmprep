...
-- all t : Teacher | some c1,c2 : Class | t->c1 in Teaches and t->c2 in Teaches implies c1 = c2  --incorrect 9
 all t : Teacher | some c1,c2 : Class | t->c1 in Teaches and t->c2 in Teaches implies c1=c2 -- all t : Teacher | some x,y : Class | t->x in Teaches and t->y in Teaches implies x=y  --incorrect 11
