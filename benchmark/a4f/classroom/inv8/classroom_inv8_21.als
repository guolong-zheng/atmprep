...
-- all t:Teacher | one t.Teaches  --incorrect 20
 all t:Teacher | some c1,c2:Class | t->c1 in Teaches and t->c2 in Teaches implies c1=c2 -- all t:Teacher | some c1,c2:Class | t->c1 in Teaches and t->c2 in Teaches implies c1=c2   --incorrect 22
