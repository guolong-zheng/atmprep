...
-- all t : Teacher | some x,y : Class | t->x in Teaches and t->y in Teaches implies x=y  --incorrect 11
 all t1,t2:Teacher | some c1,c2:Class | t1->c1 in Teaches and t2->c1 in Teaches implies t1=t2 -- all t1,t2:Teacher | some c1:Class | t1->c1 in Teaches and t2->c1 in Teaches implies t1=t2  --incorrect 13
