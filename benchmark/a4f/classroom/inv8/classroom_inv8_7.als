...
-- all t : Teacher | one c : Class | t->c in Teaches  --incorrect 6
 all t : Teacher | one c1,c2 : Class | t->c1 in Teaches and t->c2 in Teaches implies c1=c2 -- all t : Teacher | some c1,c2 : Class | t -> c1 in Teaches and t -> c2 in Teaches implies c1 = c2    --incorrect 8
