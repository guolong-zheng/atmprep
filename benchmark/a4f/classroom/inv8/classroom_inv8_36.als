...
-- some c:Class | (some t:Teacher | t->c in Teaches)  --incorrect 35
 some t1:Teacher , c:Class | t1->c in Teaches or not t1->c in Teaches -- some t1:Teacher , t2:Teacher , c:Class | (t1->c in Teaches and t2->c in Teaches) implies t1 = t2  --incorrect 37
