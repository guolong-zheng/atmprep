...
-- all c: Class | some s: Student, t: Teacher, g: Group | c->s->g in Groups implies t->c in Teaches  --incorrect 69
 all c: Class | some t :Teacher | t->c in Teaches and some c.Groups -- all c: Class | some t: Teacher , p: Person , g: Group| (c->p->g in Groups) implies (t->c in Teaches)  --incorrect 71
