...
-- all s : Person, c : Class | some s.(Teacher<:Tutors) implies some c.(Teacher<:Teaches)  --incorrect 57
 all s : Person, c : Class, t : Teacher | ((some g : Group | c->s->g in Groups) and t->c in Teaches) implies t->s in Tutors -- all s : Person, c : Class, t : Teacher | (all g : Group | c->s->g in Groups) and t->c in Teaches implies t->s in Tutors  --incorrect 59
