...
-- all c:Class,g:Group| some t:Teacher | some c.Groups.g  --incorrect 188
 all c:Class,g:Group| some t:Teacher | some c.Groups.g implies c in t.Teaches -- all c:Class,g:Group| some t:Teacher | some c.Groups.g implies c->t->g in Groups  --incorrect 190
