...
-- all s : Student | s in Class implies (some t : Teacher | t->s in Tutors)  --incorrect 64
 all s : Student | s in Class implies some t : Teacher | t->s in Tutors -- all s : Student | s in Class implies some t : Teacher | t->s in Tutors and t in Class  --incorrect 66
