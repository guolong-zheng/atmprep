...
-- all p : Person | some Teacher <: p . (^ Tutors)  --incorrect 11
 all p : Teacher | some p <: ^ Tutors -- all p,q,r : Person | (p->q in Tutors implies p in Teacher or q->p in Tutors or q->r in Tutors or r->q in Tutors         or r->p in Tutors or p->r in Tutors)    implies (p in Teacher or q in Teacher or r in Teacher)  --incorrect 13
