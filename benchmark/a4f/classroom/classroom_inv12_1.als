...
--	all t : Teacher | some (t.Teaches).Groups --correct
 all c : Class | (some p : Person, g : Group | c->p->g in Groups) implies all t : Teacher | t->c in Teaches -- all c : Class | some p : Person, g : Group | c->p->g in Groups implies p in Teacher  --incorrect 2
