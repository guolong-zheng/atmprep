...
-- all s : Student | s in Class implies some t : Teacher | t->s in Tutors  --incorrect 65
 all s : Student | s in Class implies some t : Teacher | t->s in Tutors and t in Class -- all s : Student | s in Class implies some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches  --incorrect 67
