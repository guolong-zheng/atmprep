...
-- all s : Student | (some c : Class, g : Group | c->s->g  in Groups) implies some t : Teacher | t->s in Tutors  --incorrect 61
 all s : Student | (some c : Class, g : Group | c->s->g in Groups) implies some t : Teacher | t->s in Tutors -- all s : Student | (some t : Teacher | t->s in Tutors) implies s in Class  --incorrect 63
