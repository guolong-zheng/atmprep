...
-- all c:Class | some Groups.Person   --incorrect 113
 all c:Class | some p : Person, g:Group | c->p->g in Groups implies p in Teacher                -- all c:Class | some p:Person | c->p->Group in Groups implies p in Teacher  --incorrect 115
