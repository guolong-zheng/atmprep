...
-- all c:Class , t:Teacher, s:Student, g:Group|(c->s->g in Groups and t->c in Teaches) implies t->s in Tutors  --incorrect 24
 all c:Class , t:Teacher, s:Student, g:Group|(t->c in Teaches and c->s->g in Groups) implies t->s in Tutors -- all c:Class,s:Student | s in (c.Groups).Group  --incorrect 26
