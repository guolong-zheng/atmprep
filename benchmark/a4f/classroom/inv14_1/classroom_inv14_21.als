...
-- all c : Class | Teaches . c . Tutors = Class . Groups . Group  --incorrect 20
 all c : Class | Teaches . c . Tutors in c . Groups . Group -- all c:Class , t:Teacher, g:Group|some s:Student | (t->c in Teaches and c->s->g in Groups) implies t->s in Tutors  --incorrect 22
