...
-- all c:Class,s:Student | s in (c.Groups).Group  --incorrect 26
 all c:Class,s:Student | s in (c.Groups).Group implies some t:Teacher | t->c in Teaches and t in s.^~Tutors -- all c:Class,s:Student | s in c.Groups.Group  --incorrect 28
