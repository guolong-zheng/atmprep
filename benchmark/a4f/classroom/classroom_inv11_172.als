...
-- all c:Class,g:Group | some t:Teacher,s:Student | ( c->s->g in Groups) implies t->c in Teaches  --incorrect 171
 all c:Class,g:Group | some t:Teacher,s:Student | s in c.Groups.g implies t->c in Teaches and t->g in c.Groups  -- all c:Class,g:Group |some p:Person,t:Teacher | p->g in c.Groups implies c->t->g in Groups  --incorrect 173
