...
-- all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c in t.Teaches implies t in s.^(~Tutors)  --incorrect 40
 all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups -- all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups implies t in s.^(~Tutors)  --incorrect 42
