...
-- all s : Student | some t : Teacher, c : Class | t->s in Tutors implies s in Class and t in Class  --incorrect 82
 all s : Student | some t : Teacher, c : Class | t->s in Tutors implies t->c in Teaches -- all s : Student | some t : Teacher, c : Class, g : Group | (t->c in Teaches implies t->s in Tutors) and c->s->g in Groups  --incorrect 84
