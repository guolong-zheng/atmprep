...
-- all s : Student, c : Class | some c -> s <: Groups implies (Teaches . c) -> s in Tutors  --incorrect 91
 all s : Student, c : Class | some c.(Teacher<:Teaches) implies some s.(Teacher<:Tutors) -- all s : Student, c : Class | some g : Group | c->s->g in Groups implies some t : Teacher | t->s in Tutors  --incorrect 93
