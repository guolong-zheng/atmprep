...
-- all s : Student | some t : Teacher, c : Class, g : Group | (t->c in Teaches implies t->s in Tutors) and c->s->g in Groups  --incorrect 84
 all s : Student | some t : Teacher, c : Class, g : Group | t->c in Teaches implies t->s in Tutors -- all s : Student | some t : Teacher, c : Class, g : Group | t->c in Teaches implies t->s in Tutors and c->s->g in Groups  --incorrect 86
