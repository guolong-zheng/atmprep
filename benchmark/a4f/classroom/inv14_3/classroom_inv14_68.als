...
-- all s : Student | s in Class implies some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches  --incorrect 67
 all s : Student | some c : Class, g : Group | c->s->g  in Groups implies some t : Teacher | t->c in Tutors -- all s : Student | some c : Class, g : Group | c->s->g  in Groups implies some t : Teacher | t->s in Tutors  --incorrect 69
