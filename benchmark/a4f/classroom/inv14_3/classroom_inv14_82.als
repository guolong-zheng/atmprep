...
-- all s : Student | some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches  --incorrect 81
 all s : Student | some t : Teacher, c : Class | t->s in Tutors implies s in Class and t in Class -- all s : Student | some t : Teacher, c : Class | t->s in Tutors implies t->c in Teaches  --incorrect 83
