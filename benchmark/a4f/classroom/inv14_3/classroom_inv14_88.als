...
-- all s : Student | some Tutors.s & Groups.s.Group  --incorrect 87
 all s : Student, c : Class | some (Teacher<:Teaches).c implies some s.(Teacher<:Teaches) -- all s : Student, c : Class | some (Teacher<:Teaches).c implies some s.(Teacher<:Tutors)  --incorrect 89
