...
-- all s : Student, c : Class | some (Teacher<:Tutors).c implies some s.(Teacher<:Teaches)  --incorrect 90
 all s : Student, c : Class | some c -> s <: Groups implies (Teaches . c) -> s in Tutors -- all s : Student, c : Class | some c.(Teacher<:Teaches) implies some s.(Teacher<:Tutors)  --incorrect 92
