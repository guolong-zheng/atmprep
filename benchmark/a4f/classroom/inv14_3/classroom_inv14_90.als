...
-- all s : Student, c : Class | some (Teacher<:Teaches).c implies some s.(Teacher<:Tutors)  --incorrect 89
 all s : Student, c : Class | some (Teacher<:Tutors).c implies some s.(Teacher<:Teaches) -- all s : Student, c : Class | some c -> s <: Groups implies (Teaches . c) -> s in Tutors  --incorrect 91
