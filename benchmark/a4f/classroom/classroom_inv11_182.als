...
-- all c:Class,g:Group,p:Person |some t:Teacher | c->p->g in Groups implies c->t->g in Groups  --incorrect 181
 all c:Class,g:Group,p:Person |some t:Teacher| c->p->g in Groups implies c->t->g in Groups -- all c:Class,g:Group,p:Person |some t:Teacher| c->p->g in Groups implies c->t->g in Groups and t->c in Teaches  --incorrect 183
