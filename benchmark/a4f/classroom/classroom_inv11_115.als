...
-- all c:Class | some p : Person, g:Group | c->p->g in Groups implies p in Teacher                 --incorrect 114
 all c:Class | some p:Person | c->p->Group in Groups implies p in Teacher -- all c:Class | some p:Person | c->p->Group in Groups implies Person in Teacher  --incorrect 116
