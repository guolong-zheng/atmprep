...
-- all s : Student | s in Class implies some t : Teacher | t->s in Tutors and t in Class  --incorrect 66
 all s : Student | s in Class implies some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches -- all s : Student | some c : Class, g : Group | c->s->g  in Groups implies some t : Teacher | t->c in Tutors  --incorrect 68
