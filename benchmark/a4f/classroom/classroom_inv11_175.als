...
-- all c:Class,g:Group |some p:Person,t:Teacher | p->g in c.Groups implies p in c.~Teaches  --incorrect 174
 all c:Class,g:Group |some p:Person,t:Teacher | p->g in c.Groups implies t in c.~Teaches -- all c:Class,g:Group |some t:Teacher | some c.Groups implies c->t->g in Groups  --incorrect 176
