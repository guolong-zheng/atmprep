...
-- all s, t : Person | some s.(Class.Groups) and some t<:(Teaches.Class) implies some t<:(Tutors.s)  --incorrect 112
 all s, t : Person | some s.(Class.Groups) and some t<:Teaches implies some (t<:Tutors).s -- all s, t : Person | some s.(Class.Groups) and some t<:Teaches implies some t<:(Tutors.s)  --incorrect 114
