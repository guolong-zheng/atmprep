...
-- all t : Teacher | some  Class.Teaches  --incorrect 232
 all t: Teacher, c: Class | t->c in Teaches implies some s:Student, g:Group | c->s->g in Groups -- all x : Class | some y : Person | some g : Group | x->y->g in Groups implies y in Teacher  --incorrect 234
