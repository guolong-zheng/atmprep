...
-- all c:Class,t:Teacher | one t.Teaches:>c  --incorrect 35
 all t1,t2 : Teacher, c : Class | t1->c in Teaches and t2->c in Teaches implies t1->t2 not in Teaches -- all t1,t2 : Teacher, c : Class | t1->c in Teaches implies t2->c not in Teaches  --incorrect 37
