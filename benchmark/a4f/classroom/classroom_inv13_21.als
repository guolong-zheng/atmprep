...
-- all t:Teacher,s:Student | s->t not in Tutors and t->t not in Tutors and s->t not in Tutors  --incorrect 20
 all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors -- all t:Teacher,s:Student,c:Class | t->c in Teaches and t->s in Tutors and not s->c in Teaches  --incorrect 22
