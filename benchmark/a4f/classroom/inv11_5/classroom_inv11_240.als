...
-- some c : Class | (some p : Person, g : Group | c->p->g in Groups) implies some t : Teacher | t->c in Teaches  --incorrect 239
 some c : Class | all s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- some c : Class | some p : Person | some g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 241
