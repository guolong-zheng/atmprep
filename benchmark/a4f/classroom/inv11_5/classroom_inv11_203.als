...
-- all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches  --incorrect 202
 all c:Class,s:Student,g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups -- all c:Class,s:Student,g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups    --incorrect 204
