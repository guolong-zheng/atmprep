...
-- all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups  --incorrect 201
 all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches -- all c:Class,s:Student,g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups  --incorrect 203
