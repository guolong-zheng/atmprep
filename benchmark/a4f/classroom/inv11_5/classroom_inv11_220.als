...
-- all c:Class| some t:Teacher | some Groups implies c in t.Teaches  --incorrect 219
 all c:Class|some t:Teacher | some Person.(c.Groups) implies c in t.Teaches -- all c:Class|some t:Teacher, g:Group | t->c in Teaches implies c->t->g in Groups    --incorrect 221
