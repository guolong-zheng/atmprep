...
-- all g:Group, c:Class | some p:Person | c->p->g in Groups                 --incorrect 222
 all g:Group, c:Class | some p:Person | c->p->g in Groups implies p in Teacher   -- all g:Group, c:Class | some p:Person | c->p->g in Groups implies p in Teacher                --incorrect 224
