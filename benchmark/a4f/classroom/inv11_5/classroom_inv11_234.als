...
-- all t: Teacher, c: Class | t->c in Teaches implies some s:Student, g:Group | c->s->g in Groups  --incorrect 233
 all x : Class | some y : Person | some g : Group | x->y->g in Groups implies y in Teacher -- all x : Class | some y : Person, z : Group, v : Teacher | x->y->z in Groups implies v->x in Teaches  --incorrect 235
