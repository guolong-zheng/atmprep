...
-- all p:Person, c:Class | (some t:Teacher, g:Group | c->p->g in Groups implies t->c in Teaches)  --incorrect 227
 all p:Person, c:Class, g:Group | (some t:Teacher | c->p->g in Groups implies t->c in Teaches) -- all t : Person, c : Class | (some g : Group | some s : Person | c -> s -> g in Groups) implies t -> c in Teaches  --incorrect 229
