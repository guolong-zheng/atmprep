...
-- all c:Class,s:Student | some g:Group | c->s->g in Groups and some t:Teacher | t->c in Teaches  --incorrect 200
 all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | c->t->g in Groups -- all c:Class,s:Student | some g:Group | c->s->g in Groups implies some t:Teacher | t->c in Teaches  --incorrect 202
