...
-- some c : Class | all s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 240
 some c : Class | some p : Person | some g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches -- some c : Class, s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 242
