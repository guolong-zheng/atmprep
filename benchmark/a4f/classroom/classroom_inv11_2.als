...
-- all c : Class | (some c.Groups implies some (c.Teaches & Teacher))  --incorrect 1
 all c : Class | (some g : Group, t : Teacher | c->t->g in Groups) implies some t : Teacher | t->c in Teaches -- all c : Class | (some p : Person, g : Group | c->p->g in Groups) implies some t : Teacher |  c->t in Teaches   --incorrect 3
