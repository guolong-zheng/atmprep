...
-- all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups  --incorrect 154
 all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups implies c in t.Teaches -- all c:Class,g:Group | some p:Person,t:Teacher | c->p->g in Groups implies c->t->g in Groups  --incorrect 156
