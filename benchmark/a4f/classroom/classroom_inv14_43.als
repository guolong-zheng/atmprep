...
-- all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups implies t in s.^(~Tutors)  --incorrect 42
 all c:Class,s:Student,t:Teacher|some g:Group| c->s->g in Groups and c->t->g in Groups -- all c:Class,s:Student| some t:Teacher | s in c.Groups.Group and t in c.Groups.Group implies t in s.^(~Tutors)  --incorrect 44
