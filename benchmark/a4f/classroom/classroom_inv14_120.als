...
-- all s,t : Person, c : Class | some s.(c.Groups) and some (t<:Teaches).c  --incorrect 119
 all s,t : Person, c : Class | some s.(c.Groups) and some (t<:Teaches).c implies some (t<:Tutors).s -- all s,t : Person, c : Class | some s.(c.Groups) and some t.Teaches  --incorrect 121
