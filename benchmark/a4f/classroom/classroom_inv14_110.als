...
-- all s : Student, t : Teacher | some s.(Class.Groups) implies some t.(Class.Groups)  --incorrect 109
 all s : Student, t : Teacher, c : Class | some s.(c.Groups) -- all s : Student, t : Teacher, c : Class | some s.(c<:Groups) and some (t<:Teaches).c implies some (t<:Tutors).s  --incorrect 111
