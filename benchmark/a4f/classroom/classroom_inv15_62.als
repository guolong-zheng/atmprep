...
-- Person.Tutors.Tutors.Tutors in Teacher  --incorrect 61
 some p : Teacher | some p <: ^ Tutors -- some p,q,r : Person | ((p->q in Tutors and q->r in Tutors) or (q->r in Tutors and r->p in Tutors) or (p->r in Tutors and r->p in Tutors)) implies (p in Teacher or q in Teacher or r in Teacher)  --incorrect 63
