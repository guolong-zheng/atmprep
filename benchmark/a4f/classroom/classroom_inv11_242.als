...
-- some c : Class | some p : Person | some g : Group | c->p->g in Groups implies some t : Teacher | t->c in Teaches  --incorrect 241
 some c : Class, s : Student, g : Group | c->s->g in Groups implies some t : Teacher | t->c in Teaches -- some Class.Groups iff some t:Teacher| Class in t.Teaches  --incorrect 243
