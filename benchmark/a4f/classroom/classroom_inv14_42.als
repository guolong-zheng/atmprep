...
-- all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups  --incorrect 41
 all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups implies t in s.^(~Tutors) -- all c:Class,s:Student,t:Teacher|some g:Group| c->s->g in Groups and c->t->g in Groups  --incorrect 43
