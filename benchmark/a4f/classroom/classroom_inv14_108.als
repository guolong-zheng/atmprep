...
-- all s : Student, t : Teacher | (some s.(Class.Groups)) implies some t.(Class.Groups)  --incorrect 107
 all s : Student, t : Teacher | some s.(Class.Groups) and some (t<:Teaches).Class implies some (t<:Tutors).s -- all s : Student, t : Teacher | some s.(Class.Groups) implies some t.(Class.Groups)  --incorrect 109
