...
-- all s : Student | some t : Teacher | t->s in Tutors implies s in Class  --incorrect 79
 all s : Student | some t : Teacher, c : Class | t->c in Teaches implies t->s in Tutors -- all s : Student | some t : Teacher, c : Class | t->s in Tutors and t->c in Teaches  --incorrect 81
