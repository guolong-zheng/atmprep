...
-- all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies (t->c in Teaches and t != s)  --incorrect 75
 all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies t->c in Teaches -- all c: Class, g: Group, s: Student | some t: Teacher | c->s->g in Groups implies t->c in Teaches and t != s   --incorrect 77
