...
-- all c:Class, g:Group | some p:Person | c->p->g in Groups implies p in Teacher                 --incorrect 137
 all c:Class, g:Group |some t:Teacher | t->c in Teaches implies c->t->g in Groups -- all c:Class, p : Person, g:Group | c->p->g in Groups implies p in Teacher                 --incorrect 139
