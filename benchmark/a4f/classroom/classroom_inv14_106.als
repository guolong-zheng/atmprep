...
-- all s : Student, c : Class, t : Teacher, g : Group | (c -> s -> g in Groups) and (t -> c in Teaches) implies t -> s in Tutors  --incorrect 105
 all s : Student, c : Class, t : Teacher, g : Group | (c -> s -> g in Groups) and t -> c in Teaches implies t -> s in Tutors -- all s : Student, t : Teacher | (some s.(Class.Groups)) implies some t.(Class.Groups)  --incorrect 107
