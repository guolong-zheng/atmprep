...
-- all c : Class, t, s : Person, g : Group | (t -> c not in Teaches) implies c -> s -> g not in Groups   --incorrect 63
 all c : Class, t: Teacher | t->c in Teaches implies some s:Student,g:Group | c->s->g in Groups -- all c : Class, t: Teacher | t->c not in Teaches implies not some s:Student,g:Group | c->s->g in Groups  --incorrect 65
