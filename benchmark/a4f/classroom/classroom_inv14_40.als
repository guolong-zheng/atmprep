...
-- all c:Class,s:Student,t:Teacher, g:Group| some s.(c.Groups)->g and some t.(c.Groups)->g implies t in s.^~Tutors  --incorrect 39
 all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c in t.Teaches implies t in s.^(~Tutors) -- all c:Class,s:Student,t:Teacher,g:Group| c->s->g in Groups and c->t->g in Groups  --incorrect 41
