...
-- all s:Student,c:Class,g:Group|some t:Teacher | some s.(c.Groups)  --incorrect 143
 all s:Student,c:Class,g:Group|some t:Teacher | some Teacher -- all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups)  --incorrect 145
