...
-- all s:Student,c:Class | some t:Teacher | some s.(c.Groups)  --incorrect 135
 all s:Student,c:Class | some t:Teacher | some s.(c.Groups) and some t.(c.Groups) -- all s:Student,c:Class | some t:Teacher | some s.(c.Groups) and some t.(c.Groups) implies t in s.^~Tutors  --incorrect 137
