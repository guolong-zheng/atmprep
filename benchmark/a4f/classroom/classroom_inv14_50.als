...
-- all p : Person | some c : Class, g : Group | c->p->g in Groups implies p in Student and some t : Teacher | t->p in Tutors and t->c in Teaches  --incorrect 49
 all p : Person | some c : Class, g : Group | c->p->g in Groups implies p->c in Teaches -- all p : Person | some c : Class, g : Group | c->p->g in Groups implies some q : Person | q->c in Teaches  --incorrect 51
