...
-- some t1:Teacher , c:Class | t1->c in Teaches or not t1->c in Teaches  --incorrect 36
 some t1:Teacher , t2:Teacher , c:Class | (t1->c in Teaches and t2->c in Teaches) implies t1 = t2 -- some t1:Teacher , t2:Teacher, c:Class | (t1->c in Teaches and t2->c in Teaches) implies t1 = t2 or (not t1->c in Teaches and not t2->c in Teaches)  --incorrect 38
