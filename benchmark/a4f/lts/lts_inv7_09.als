...
-- all s1,s2:State, e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans  all s:State,e1,e2:Event | s->e1->s in trans implies s->e1->s in trans  --incorrect 8
 all s1,s2:State, e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans  all s:State,e1,e2:Event | s->e1->s in trans implies s->e2->s in trans -- all s1,s2:State, e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans and s1 in e2.(s1.trans)  --incorrect 10
