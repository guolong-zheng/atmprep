...
-- all s1,s2 : State, e : Event | e.(s1.trans) = e.(s2.trans)  --incorrect 19 
 all s1,s2:State |some e:Event |some e.(s1.trans) implies some e.(s2.trans) -- all s1,s2:State|some e:Event | some e.(s1.trans) implies some e.(s2.trans)  --incorrect 21
