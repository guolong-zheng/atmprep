...
-- all s1,s2:State, e1,e2,e3,e4:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans  --incorrect 6 
 all s1,s2:State, e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans -- all s1,s2:State, e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans  all s:State,e1,e2:Event | s->e1->s in trans implies s->e1->s in trans  --incorrect 8
