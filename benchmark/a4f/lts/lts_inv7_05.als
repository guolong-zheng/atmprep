...
-- all s1, s2:State, e:Event | s1->e->s2 in trans implies s2->e->s1 in trans  --incorrect 4
 all s1,s2:State | some e1,e2:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans -- all s1,s2:State, e1,e2,e3,e4:Event  | s1->e1->s2 in trans implies s2->e2->s1 in trans  --incorrect 6 
